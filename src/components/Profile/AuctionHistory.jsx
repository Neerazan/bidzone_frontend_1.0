                                        ...
                                        <div className="flex items-center sm:items-start">
                                            ...
                                            <div className="flex-1 ml-6 text-sm">
                                                ...
                                                <p className="hidden text-gray-500 sm:block sm:mt-2">
                                                    Are you a minimalist looking
                                                    for a compact carry option?
                                                    The Micro Backpack is the
                                                    perfect size for your
                                                    essential everyday carry
                                                    items. Wear it like a
                                                    backpack or carry it like a
