    ...
    return (
        <div className="relative">
            <button
                ...
                className="inline-flex items-center font-medium justify-center px-2 text-sm text-gray-900 rounded-full cursor-pointer border hover:border-slate-900 border-slate-600 ml-2"
