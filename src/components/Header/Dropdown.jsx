                        ...
                        <ul className="py-2 font-medium" role="none">
                            ...
                            <li className="px-4 hover:bg-gray-100">
                                <Link
                                    ...
                                    onClick={toggleDropdown}
                                >
                                    <div className="inline-flex items-center">Profile</div>
                                </Link>
                            </li>
                            <li className="px-4 hover:bg-gray-100">
                                <Link
                                    ...
                                    onClick={toggleDropdown}
                                >
                                    <div className="inline-flex items-center">Auction</div>
                                </Link>
                            </li>
                            <li className="px-4 hover:bg-gray-100">
                                <Link
                                    ...
                                    onClick={toggleDropdown}
                                >
                                    <div className="inline-flex items-center">Products</div>
                                </Link>
                            </li>
                            <li className="px-4 hover:bg-gray-100">
                                <Link
